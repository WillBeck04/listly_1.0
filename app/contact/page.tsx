    ...
    <div className="min-h-screen bg-blue-500 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-lg w-full">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-gray-600">
            <span className="font-semibold">Salomon Lavy:</span> <a href="mailto:salomon.lavy@mail.mcgill.ca" className="text-blue-600 hover:text-blue-700 transition duration-300 ease-in-out">salomon.lavy@mail.mcgill.ca</a>
          </p>
          <p className="text-gray-600">
